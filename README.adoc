...
---
Web service rest extraí do link:https://github.com/arquivo/pywb-opensearch-cdx[OpenSearch] página web colhidas. De seguida, recolhe dos sites número parametrizável de imagens de cada página, atribuindo a cada imagem um score para o ranking final. Usa também o link:https://github.com/ikreymer/pywb/wiki/CDX-Server-API[CDXServer] para verificar se o recurso foi bem indexado.
...
#Configurations
	 File blacklist url: /getimagesWS/ 
